...
public class HoaDon {
	...
	public HoaDon(String maHD, LocalDateTime ngayLapHD, NhanVien nhanVien, KhachHang khachHang, double khuyenMai,
			double tienKhachDua, ArrayList<ChiTietHoaDon> dsCTHD, String ghiChu) throws Exception {
		this.maHD = maHD;
		try {
...
//	}
	public void setKhuyenMai() throws Exception {
...
//	}
	...
	public double TinhTienTraLai(double tienNhap) throws Exception {
		
		return tienNhap - TinhTongTien();
	}
	...
	public double TinhTongKhuyenMai() throws Exception {
		//phuong thuc tinh tong khuyen mai
		return TinhThanhTien() * this.khuyenMai;
	}
...
//		}
		...
		threeColTable7.addCell(
				ToPDFController.getHeaderLeftTextCellValue(MainFrame.moneyFormatter.format(
						this.TinhTienTraLai(this.getTienKhachDua()))).setTextAlignment(TextAlignment.RIGHT).setMarginRight(15f));
