...
public class PnlKhachHang extends JPanel {
    ...
    public PnlKhachHang() {
        ...
        textNamSinh.setBounds(184, 262, 186, 32);
        panel.add(textNamSinh);
        textNamSinh.setColumns(10);
        
        JLabel lblNamSinh = new JLabel("Số Điện Thoại:");
		...
		// Kiểm tra và chuyển đổi giá trị từ textLuong
          ...
          if (!namSinhStr.isEmpty()) {
              ...
              if (namSinhValue > 0) {
                  ...
                  throw new Exception("Vui lòng nhập năm sinh lớn hơn 0");
              }
          } else {
              throw new Exception("Vui lòng nhập số năm sinh");
          }


          // Tạo đối tượng NhanVien từ dữ liệu
          KhachHang kh = new KhachHang(maKH, tenKH, diaChi, sdt, namSinh, nam);
