...
//	    String maNV = "NV00000000";
	    ...
	    String maKH = kh.getMaKHbySDT(sdt); 
	    ...
	    dsCTHD =taoDSChiTietHD();

	    newHoaDon = new HoaDon(maHD, ngayLapHD, newNv, newKh, gtKhuyenMai, tienDua, dsCTHD, ghiChu);
	    return newHoaDon;
	}
//	public ArrayList<ChiTietHoaDon> layDanhSachChiTietHoaDonTuBang() throws Exception {
...
//	}
	...
	private void timSDT() {
		// TODO Auto-generated method stub
		String sdt = txtTim.getText().trim();
		String tenKHTimDuoc = kh.getTenKHbySDT(sdt);
