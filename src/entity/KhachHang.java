...
public class KhachHang {
	...
	public void setTenKH(String tenKH) throws Exception {
		...
		if (tenKH.length() > 50)
			throw new Exception("Tên khách hàng bé hơn 50 ký tự");
		this.tenKH = tenKH;
	}
	...
	public void setSdt(String sdt) throws Exception {
		if (sdt.length() != 10)
			throw new Exception("sdt phải đúng 10 ký tự");
		this.sdt = sdt;
	}
	...
	public String toString() {
		return "KhachHang [maKH=" + maKH + ", tenKH=" + tenKH + ", diaChi=" + diaChi + ", sdt=" + sdt + ", namSinh="
				+ namSinh + ", gioiTinh=" + gioiTinh + "]";
	}
